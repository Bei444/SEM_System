<%-- Created by IntelliJ IDEA. User: 北 Date: 2023/5/24 Time: 18:52 To change this template use File | Settings | File
    Templates. --%>
                    ...
                    <div class="nav-item text-nowrap d-flex align-items-center">
                        ...
                        <div class="dropdown px-3">
                            ...
                            <ul class="dropdown-menu bg-white shadow">
                                ...
                                <li>
                                    <a class="dropdown-item" href="/student/profile.jsp">
                                ...
                                <li>
                                    <a class="dropdown-item" href="/student/setting.jsp">
                    ...
                    <nav id="sidebarMenu" class="col-md-3 col-lg-3 d-md-block sidebar collapse">
                        <div class="position-sticky py-4 px-3 sidebar-sticky">
                            <ul class="nav flex-column h-100">
                                ...
                                <li class="nav-item">
                                    <a class="nav-link active" href="/student/wallet.jsp">
