...
<%-- Created by IntelliJ IDEA. User: 北 Date: 2023/5/25 Time: 10:25 To change this template use File | Settings | File
    Templates. --%>
        ...
        <div class="nav-item text-nowrap d-flex align-items-center">
            ...
            <div class="dropdown px-3">
                ...
                <ul class="dropdown-menu bg-white shadow">
                    ...
                    <li>
                        <a class="dropdown-item" href="/TeacherInformation">
        ...
        <nav id="sidebarMenu" class="col-md-3 col-lg-3 d-md-block sidebar collapse">
            <div class="position-sticky py-4 px-3 sidebar-sticky">
                <ul class="nav flex-column h-100">
                    ...
                    <li class="nav-item">
                        <a class="nav-link active" href="/TeacherStudentInformation">
        ...
        <main class="main-wrapper col-md-9 ms-sm-auto py-4 col-lg-9 px-md-4 border-start">
            ...
            <div class="search">
                <form action="" method="post">
                    <div class="searchBox">学号<input type="text"></div>
                    <div class="searchBox">姓名<input type="text"></div>
                    <div class="searchBox">性别<input type="text"></div>
                    <div class="searchBox">班级<input type="text"></div>
                ...
                <div class="tableBox">
                    <table border="1px" cellpadding="5px" cellspacing="1px">
                        ...
                        <tr>
                            ...
                            <td>
                                <a href="#" onclick="">查看就业信息</a>
                                    <%--                            <a href="#" onclick="popDiv()">查看就业信息</a>--%>
                                <a href="#">删除</a>
                            </td>
                        </tr>
                    </table>
            ...
            <%--                    <div class="addBox">--%>
            <%--                        <span>就业状态</span>--%>
            <%--                        <input type="radio" class="radio" name="">在职--%>
            <%--                        <input type="radio" class="radio" name="">面试中--%>
            <%--                        <input type="radio" class="radio" name="">已离职--%>
            <%--                    </div>--%>
